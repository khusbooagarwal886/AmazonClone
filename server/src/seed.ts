...
export const sampleProducts = [
  ...
  // ==================== COMPUTERS & ACCESSORIES (16 Products) ====================
  {
...
async function seedDatabase(): Promise<void> {
  try {
    ...
    logger.info(`Successfully seeded ${inserted.length} products with realistic INR prices!`);
...
// Only run auto-seeding if executed directly from CLI
